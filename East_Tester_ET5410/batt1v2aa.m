% batt1v2aa.m is a GNU Octave script, that sets up East Tester ET5410 for discharging a 1.2 V AA battery.
...
if (error == 0)
    disp ("Success: ET5410 is ready for discharging a 1.2 V AA battery");
endif
